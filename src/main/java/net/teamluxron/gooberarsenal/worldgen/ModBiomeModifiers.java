...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_SOUPHYRE = registerKey("add_soulphyre");
    public static final ResourceKey<BiomeModifier> ADD_ROSE_QUARTZ = registerKey("add_rose_quartz");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_SOUPHYRE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_NETHER),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.SOULPHYRE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));

        context.register(ADD_ROSE_QUARTZ, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_NETHER),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.ROSE_QUARTZ_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
